(ns com.datastax.configbuilder.operator
  ...
  (:gen-class
   :name com.datastax.configbuilder.CassOperatorConfigBuilder))
...
(defn make-configs
  ...
  (let [;; We have to unjson the config-file-data, change it, and re-serialize it to json
        config-file-data-parsed  (json/parse-string config-file-data keyword)
